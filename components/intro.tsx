    ...
    >
      ...
      >
        <a
          ...
          target="_blank"
          rel="noopener"
          className="flex items-center transition justify-center md:hover:scale-105"
        >
          <Badge>Disponible para trabajar</Badge>
        </a>

        <p className="text-4xl font-bold tracking-tight text-gray-800 sm:text-5xl dark:text-white">
        ...
        <p className="mt-6 text-xl text-gray-800 dark:[&>strong]:text-yellow-200 [&>strong]:text-yellow-500 [&>strong]:font-semibold dark:text-gray-300">
          ...
          Barcelona, España 🇪🇸. Especializado en el desarrollo de aplicaciones
          web únicas.
        </p>
      </motion.h1>
